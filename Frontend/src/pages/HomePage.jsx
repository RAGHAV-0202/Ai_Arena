...
function HomePage() {
  return (
    <div className="relative w-full min-h-screen flex items-center bg-black overflow-hidden flex-col overflow-x-hidden">
      ...
      <div className="relative z-10 text-white w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8  pt-5"> 
        <Navbar/>
        <Hero/>
        <Features/>
      </div>
